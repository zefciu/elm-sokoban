...
var author$project$Main$LevelSetLoaded = function (a) {
	return {$: 'LevelSetLoaded', a: a};
};
var author$project$Main$levelSetUrl = '/alberto.txt';
...
var author$project$Board$empty = {
	grid: A3(author$project$Grid$repeat, 0, 0, _List_Nil),
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		elm$http$Http$get(
			{
				expect: elm$http$Http$expectString(author$project$Main$LevelSetLoaded),
				url: author$project$Main$levelSetUrl
			}));
};
...
var author$project$Main$subscriptions = function (model) {
	...
	if (_n0.$ === 'Initial') {
		...
		return A2(elm$core$Platform$Sub$map, author$project$Main$KeyMsg, ohanhi$keyboard$Keyboard$subscriptions);
	}
};
...
var author$project$Grid$fromList = function (lst) {
	if (!lst.b) {
		return elm$core$Maybe$Just(
		...
		return A2(
			...
			author$project$Grid$fromList(tails));
	}
};
var author$project$Grid$foldl = F3(
...
var author$project$Grid$nextIndex = F2(
	function (_n0, _n1) {
		var x = _n0.a;
		var y = _n0.b;
		var w = _n1.a.w;
		var h = _n1.a.h;
		var data = _n1.a.data;
		return _Utils_eq(x, w - 1) ? _Utils_Tuple2(0, y + 1) : _Utils_Tuple2(x + 1, y);
	});
var author$project$Grid$indexedMap = F2(
	function (func, grid) {
		...
		var newData = _n1.c;
		return author$project$Grid$Grid(
			{data: newData, h: h, w: w});
	});
var author$project$Util$findInGrid = F2(
	function (f, grid) {
		return A3(
			author$project$Grid$foldl,
			F2(
			...
			A2(
				...
				F3(
					function (x, y, v) {
						return f(v) ? elm$core$Maybe$Just(
...
var author$project$Loader$boardFromList = function (list) {
	var grid = A2(
		elm$core$Maybe$withDefault,
		A3(author$project$Grid$repeat, 0, 0, _List_Nil),
		author$project$Grid$fromList(list));
	return {
		grid: grid,
		playerPos: A2(
			elm$core$Maybe$withDefault,
			_Utils_Tuple2(0, 0),
			A2(
				author$project$Util$findInGrid,
				function (x) {
					return A2(
						elm$core$List$any,
						elm$core$Basics$eq(author$project$Board$Player),
						x);
				},
				grid))
	};
...
var author$project$Loader$parseField = function (c) {
	switch (c.valueOf()) {
		case ' ':
			return _List_Nil;
		case '.':
		...
		case '*':
			return _List_fromArray(
				[author$project$Board$Crate, author$project$Board$Target]);
		case '+':
			return _List_fromArray(
				[author$project$Board$Player, author$project$Board$Target]);
		default:
			return _List_Nil;
	}
};
...
var author$project$Loader$parseLine = F2(
	function (line, _n0) {
		var loaded = _n0.a;
		var current = _n0.b;
		return A2(elm$core$String$startsWith, line, ';') ? _Utils_Tuple2(
			_Utils_ap(
				loaded,
				_List_fromArray(
					[current])),
			...
			A2(
				...
				A2(
					elm$core$List$map,
					author$project$Loader$parseField,
...
var author$project$Util$padList = F3(
	function (l, x, xs) {
		var missing = l - elm$core$List$length(xs);
		return (missing > 0) ? _Utils_ap(
			xs,
			A2(elm$core$List$repeat, missing, x)) : xs;
	});
...
var author$project$Util$padToLongest = F2(
	function (x, xs) {
		var _n0 = elm$core$List$maximum(
			A2(elm$core$List$map, elm$core$List$length, xs));
		if (_n0.$ === 'Just') {
			var l = _n0.a;
			return A2(
				elm$core$List$map,
				A2(author$project$Util$padList, l, x),
				xs);
		} else {
			return xs;
		}
...
var author$project$Loader$loadLevels = function (data) {
	return elm$core$Array$fromList(
		A2(
			elm$core$List$map,
			author$project$Loader$boardFromList,
			A2(
				elm$core$List$map,
				author$project$Util$padToLongest(_List_Nil),
				A3(
					elm$core$List$foldl,
					author$project$Loader$parseLine,
					_Utils_Tuple2(_List_Nil, _List_Nil),
					elm$core$String$lines(data)).a)));
};
var author$project$Main$Playing = {$: 'Playing'};
var author$project$Board$isWon = function (board) {
	var _n0 = A2(
		author$project$Util$findInGrid,
		elm$core$Basics$eq(
			_List_fromArray(
...
var author$project$Main$progressLevel = function (model) {
	return _Utils_update(
		model,
		{
			board: A2(
				...
				A2(elm$core$Array$get, model.currentLevel + 1, model.levels)),
			currentLevel: model.currentLevel + 1
		});
};
var author$project$Main$checkVictory = function (_n0) {
	var model = _n0.a;
	var msg = _n0.b;
	return author$project$Board$isWon(model.board) ? _Utils_Tuple2(
		author$project$Main$progressLevel(model),
...
var author$project$Board$addArrows = F2(
	function (_n0, arrows) {
		var x = _n0.a;
		var y = _n0.b;
		return _Utils_Tuple2(x + arrows.x, y - arrows.y);
	});
var author$project$Grid$inRange = F4(
	function (x, y, w, h) {
...
var author$project$Grid$get = F2(
	function (_n0, grid) {
		...
		var h = grid.a.h;
		var data = grid.a.data;
		return A4(author$project$Grid$inRange, x, y, w, h) ? A2(elm$core$Array$get, x + (y * w), data) : elm$core$Maybe$Nothing;
	});
...
var author$project$Grid$set = F3(
	function (_n0, elem, grid) {
		...
		var h = grid.a.h;
		var data = grid.a.data;
		return A4(author$project$Grid$inRange, x, y, w, h) ? author$project$Grid$Grid(
			{
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'KeyMsg') {
			var keyMsg = msg.a;
			return author$project$Main$checkVictory(
				author$project$Main$processRestart(
					author$project$Main$processMove(
						A2(author$project$Main$processKey, model, keyMsg))));
		} else {
			if (msg.a.$ === 'Ok') {
				var data = msg.a.a;
				var levels = author$project$Loader$loadLevels(data);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							board: A2(
								elm$core$Maybe$withDefault,
								author$project$Board$empty,
								A2(elm$core$Array$get, 0, levels)),
							currentLevel: 0,
							levels: author$project$Loader$loadLevels(data),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{board: author$project$Board$empty, currentLevel: 0, levels: elm$core$Array$empty, state: author$project$Main$Playing}),
					elm$core$Platform$Cmd$none);
			}
		}
	});
					...
					while (true) {
						if (field.b) {
							if (!field.b.b) {
								...
								if ((field.b.a.$ === 'Target') && (!field.b.b.b)) {
									switch (field.a.$) {
										case 'Crate':
											var _n5 = field.a;
											var _n6 = field.b;
...
var author$project$Main$viewRow = function (row) {
	return A2(
		...
		elm$core$Array$toList(
			A2(elm$core$Array$map, author$project$Main$viewField, row)));
};
	...
	return A2(
		...
		elm$core$Array$toList(
			A2(
				...
				author$project$Grid$rows(model.board.grid))));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"KeyMsg":["Keyboard.Msg"],"LevelSetLoaded":["Result.Result Http.Error String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Keyboard.Msg":{"args":[],"tags":{"Down":["Keyboard.RawKey"],"Up":["Keyboard.RawKey"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Keyboard.RawKey":{"args":[],"tags":{"RawKey":["String.String"]}}}}})}});}(this));